...
tf.compat.v1.flags.DEFINE_bool('feat_diff_dipstick', None, '')
tf.compat.v1.flags.DEFINE_string('feat_freetext_to_id_fp', '', '')
tf.compat.v1.flags.DEFINE_bool('feat_beat_phase', None, '')
tf.compat.v1.flags.DEFINE_bool('feat_beat_phase_cos', None, '')
...
def main(_):
    ...
    with tf.compat.v1.Graph().as_default(), tf.compat.v1.Session() as sess:
        ...
        if do_train:
            ...
            epoch_mean_xentropy = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name='epoch_mean_xentropy')
            epoch_mean_time = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name='epoch_mean_time')
            epoch_var_xentropy = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name='epoch_var_xentropy')
            epoch_var_time = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name='epoch_var_time')
            ...
            for eval_metric_name in eval_metric_names:
                ...
                ph_mean = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name=name_mean)
                ph_var = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name=name_var)
            ...
            eval_time = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=[], name='eval_time')
